...
const TravelAdvice = () => {
  ...
  const writeComment = async () => {
    const result = addDoc(collection(firestore, "TravelAdviceUserComment"), {
      question: comm,
          ...
          <Table>
            ...
            <div className="questions">
              ...
              <Link target="_blank" to="/whichbetternainimanali">
                <div className="ques">
                  <img src="/Images/question.png" alt="" />
                  <h2>Which is better? Nainital or Manali?</h2>
                </div>
              </Link>
              <Link>
                <div className="ques">
                  <img src="/Images/question.png" alt="" />
                  <h2>2 day sight seeing in Mumbai</h2>
                </div>
              </Link>
              <Link>
                <div className="ques">
                  <img src="/Images/question.png" alt="" />
                  <h2>Hill Stations in India</h2>
                </div>
              </Link>
              <Link>
                <div className="ques">
                  <img src="/Images/question.png" alt="" />
                  <h2>Cloths to wear for water adventure?</h2>
                </div>
              </Link>
              <Link>
                <div className="ques">
                  <img src="/Images/question.png" alt="" />
                  <h2>How to reach Kailash Mansarovar</h2>
                </div>
              </Link>
              <Link
                style={{
              ...
              >
                <div className="ques">
                  <img src="/Images/question.png" alt="" />
                  <h2>How to travel to Shimla for Nagpur</h2>
                </div>
              </Link>
            </div>
          </Table>
